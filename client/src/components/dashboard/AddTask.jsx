      ...
      <form  className='flex flex-col gap-4'>
          ...
          <textarea name="description"
                ...
                <div className='flex items-center justify-between gap-4'>
                    ...
                    <button className='w-full border border-black py-2 hover:bg-zinc-100 transition-all duration-300 text-black rounded' onClick={()=>setAddTaskDiv("hidden")} >Cancel</button>
                </div>
         </form>
    </div>
  )
